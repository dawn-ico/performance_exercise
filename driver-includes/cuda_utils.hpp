...
namespace dawn
{
  ...
  inline void initField(::dawn::float_type *const field, dawn::float_type **cudaStorage, int kSize)
  {
  ...
  inline void initField(::dawn::float_type *const field, dawn::float_type **cudaStorage, int denseSize,
  ...
  inline void initSparseField(::dawn::float_type *const field, dawn::float_type **cudaStorage,
